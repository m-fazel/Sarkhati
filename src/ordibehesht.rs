...
pub type OrdibeheshtOrderData = StandardOrderData;

impl StandardBrokerConfig for OrdibeheshtConfig {
    fn cookie(&self) -> &str {
        &self.cookie
    }
...
pub async fn send_order(
    config: &OrdibeheshtConfig,
    order: &OrdibeheshtOrderData,
    test_mode: bool,
    curl_only: bool,
...
pub async fn run_calibration(
    ...
    standard_broker::run_calibration("Ordibehesht", config, client, rate_limiter).await
}
