...
pub type MaskanOrderData = StandardOrderData;

impl StandardBrokerConfig for MaskanConfig {
    fn cookie(&self) -> &str {
        &self.cookie
    }
...
pub async fn run_calibration(
    ...
    standard_broker::run_calibration("Maskan", config, client, rate_limiter).await
}
