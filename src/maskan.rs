...
pub struct MaskanConfig {
    pub cookie: String,
    #[serde(default = "default_user_agent")]
    pub user_agent: String,
    #[serde(default = "default_order_url")]
    pub order_url: String,
    pub orders: Vec<MaskanOrderData>,
...
fn default_order_url() -> String {
    "https://api.maskanbrokerage.ir/Web/V1/Order/Post".to_string()
}
...
pub async fn send_order(
    ...
    if test_mode {
        println!("[Maskan] Equivalent curl command:");
        println!(r#"curl '{}' \
  --compressed \
  -X POST \
  -H 'User-Agent: {}' \
  ...
  --data-raw '{}'"#,
    ...
    println!("[Maskan] Sending order JSON: {}", order_json);
    ...
    println!("[Maskan] Order response status: {}", status);
    println!("[Maskan] Order response body: {}", decoded_text);
...
pub async fn run_calibration(
    ...
    calibration::run_calibration("[Maskan]", calibration, rate_limiter, || {
