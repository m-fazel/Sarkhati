...
pub type SamanOrderData = StandardOrderData;

impl StandardBrokerConfig for SamanConfig {
    fn cookie(&self) -> &str {
        &self.cookie
    }
...
pub async fn run_calibration(
    ...
    standard_broker::run_calibration("Saman", config, client, rate_limiter).await
}
